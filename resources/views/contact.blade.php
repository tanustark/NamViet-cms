...
@section('content')
    ...
    <div class="col-lg-8 col-lg-offset-1 panel panel-default">
        ...
        <div class="col-lg-3" style="padding-top: 20px" id="contact-img">
            <img src="./assets/img/person-placeholder.jpg" width="230" height="230">
        </div>
        <div class="col-lg-4">
            <h3 style="padding-left: 15px">General Director</h3>
            <ul class="list-group" style="line-height: 30px; font-size: 12pt">
                <li class="list-group-item"><i class="glyphicon glyphicon-user"></i>Mr. Nguyen Minh Viet </li>
                <li class="list-group-item"><i class="glyphicon glyphicon-envelope"></i>minhvietnguyen75@gmail.com</li>
                <li class="list-group-item"><i class="glyphicon glyphicon-phone"></i>(+84) 988 898 988 </li>
                <li class="list-group-item"><i class="fa fa-twitter"></i>minhvietng75</li>
